...
function DaoIndexData() {
    this.getNTU = function (callback) {
        var options = {
        ...
        request(options, function (err, res) {
            ...
            callback && callback(ntuData)
        })

    }
    this.getBili = function (callback) {
        var options = {
